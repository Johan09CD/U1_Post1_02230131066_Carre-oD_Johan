...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val paradigmas = listOf(
            Triple("Nativo", "Kotlin/Swift",
                "Rendimiento maximo, acceso completo a APIs"),
            Triple("Hibrido", "Ionic/Capacitor",
                "Tecnologias web en contenedor nativo"),
            Triple("Multiplataforma", "Flutter/React Native",
    ...
    private fun createCard(
        title: String, tech: String, desc: String
    ): LinearLayout {
        return LinearLayout(this).apply {
            ...
            addView(TextView(context).apply {
                text = "Tecnologia: $tech"; textSize = 14f
                setTextColor(Color.parseColor("#1C7293"))
            })
            addView(TextView(context).apply {
                text = desc; textSize = 14f
                setPadding(0, 8, 0, 0)
            })
        }
    }
